...
/**
 * Shaded api for custom, {@link Http2ConnectionHandler#connection()} will return {@link com.bachlinh.order.core.http.server.channel.http2.ProxiedHttp2Connection}
...
public class Http2FrameCodec extends Http2ConnectionHandler {
    ...
    private final class FrameListener implements Http2FrameListener {
        ...
        private Http2FrameStream requireStream(int streamId) {
            ...
            if (stream == null) {
                String message = STR. "Stream object required for identifier: \{ streamId }" ;
