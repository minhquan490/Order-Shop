...
public class HttpConversionUtil {
    ...
    static {
        ...
        HTTP_TO_HTTP3_HEADER_BLACKLIST.add(io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.STREAM_ID.text(), EMPTY_STRING);
        HTTP_TO_HTTP3_HEADER_BLACKLIST.add(io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.SCHEME.text(), EMPTY_STRING);
        HTTP_TO_HTTP3_HEADER_BLACKLIST.add(io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.PATH.text(), EMPTY_STRING);
    }
     ...
     */
    public static FullHttpResponse toFullHttpResponse(long streamId, Http3Headers http3Headers, ByteBufAllocator alloc,
     ...
     * @throws Http3Exception
     */
    public static FullHttpRequest toFullHttpRequest(long streamId, Http3Headers http3Headers, ByteBufAllocator alloc,
                                                    boolean validateHttpHeaders) throws Http3Exception {
        ByteBuf content = alloc.buffer();
     ...
     * @throws Http3Exception
     */
    public static HttpResponse toHttpResponse(final long streamId,
     ...
     */
    public static void addHttp3ToHttpHeaders(long streamId, Http3Headers inputHeaders,
     ...
     * @throws Http3Exception If not all HTTP/3 headers can be translated to HTTP/1.x.
     */
    public static void addHttp3ToHttpHeaders(long streamId, Http3Headers inputHeaders, HttpHeaders outputHeaders,
        ...
        if (!isTrailer) {
            outputHeaders.set(io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.STREAM_ID.text(), streamId);
     ...
     * <ul>
     * <li>{@link io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames#SCHEME}</li>
     * </ul>
     * {@link io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames#PATH} is ignored and instead extracted from the {@code Request-Line}.
     */
    public static Http3Headers toHttp3Headers(HttpMessage in, boolean validateHeaders) {
    ...
    public static Http3Headers toHttp3Headers(HttpHeaders inHeaders, boolean validateHeaders) {
     ...
     */
    private static void toHttp3HeadersFilterTE(Map.Entry<CharSequence, CharSequence> entry,
                                               Http3Headers out) {
    ...
    public static void toHttp3Headers(HttpHeaders inHeaders, Http3Headers out) {
    ...
    private static void setHttp3Scheme(HttpHeaders in, URI uri, Http3Headers out) {
        ...
        CharSequence cValue = in.get(io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.SCHEME.text());
        if (cValue != null) {
    ...
    private static final class Http3ToHttpHeaderTranslator {
        ...
        static {
            ...
            RESPONSE_HEADER_TRANSLATIONS.add(Http3Headers.PseudoHeaderName.SCHEME.value(),
                    io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.SCHEME.text());
            REQUEST_HEADER_TRANSLATIONS.add(RESPONSE_HEADER_TRANSLATIONS);
            RESPONSE_HEADER_TRANSLATIONS.add(Http3Headers.PseudoHeaderName.PATH.value(),
                    io.netty.incubator.codec.http3.HttpConversionUtil.ExtensionHeaderNames.PATH.text());
        }
