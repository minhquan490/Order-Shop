...
public class JpaTransactionManager extends AbstractPlatformTransactionManager
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            ...
            // Use pattern one transaction per request cause deadlock.
            // Refactor this JpaDialect for implement one transaction per request pattern
    ...
    protected void doCommit(DefaultTransactionStatus status) {
        ...
        try {
            EntityManager entityManager = txObject.getEntityManagerHolder().getEntityManager();
    ...
    public class JpaTransactionObject extends JdbcTransactionObjectSupport {
        ...
        public void flush() {
            try {
                EntityManager entityManager = getEntityManagerHolder().getEntityManager();
                if (entityManager.isOpen()) {
                    entityManager.flush();
                }
            } catch (RuntimeException ex) {
