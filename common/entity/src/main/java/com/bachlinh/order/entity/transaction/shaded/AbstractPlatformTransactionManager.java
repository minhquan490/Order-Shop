...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager, Serializable {
     ...
     * <p>The recommended solution for handling failure of a sub-transaction
     * is a "nested transaction", where the global transaction can be rolled
     * back to a savepoint taken at the beginning of the sub-transaction.
    ...
    private TransactionStatus handleExistingTransaction(
        ...
        if (definition.getPropagationBehavior() == TransactionDefinition.PROPAGATION_NESTED) {
            ...
            if (useSavepointForNestedTransaction()) {
                ...
                // Usually uses JDBC 3.0 savepoint. Never activates Spring synchronization.
        ...
        // Assumable PROPAGATION_SUPPORTS or PROPAGATION_REQUIRED.
        if (debugEnabled) {
    ...
    /**
     * Resume outer transaction after inner transaction being failed.
     */
    ...
    private void processCommit(DefaultTransactionStatus status) throws TransactionException {
        try {
            ...
            try {
                ...
                boolean unexpectedRollback = status.isRollbackOnly();
     ...
     * Transaction synchronization will be resumed afterward.
     * <p>The default implementation throws a TransactionSuspensionNotSupportedException,
     * assuming that transaction suspension is generally not supported.
     *
     * @param transaction        the transaction object returned by {@code doGetTransaction}
     ...
     * a rollback in that case, throwing an UnexpectedRollbackException afterward.
    ...
    protected static final class SuspendedResourcesHolder {
        ...
        private SuspendedResourcesHolder(
                @Nullable Object suspendedResources, @Nullable List<TransactionSynchronization> suspendedSynchronizations,
