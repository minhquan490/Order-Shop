...
public abstract class JoinFormulaAdapter extends AbstractFormulaProcessor implements JoinFormulaProcessor {
    ...
    @Override
    public final String processJoin(String sql, TableMetadataHolder targetTableMetadata, Map<Class<? extends AbstractEntity<?>>, TableMetadataHolder> tableMetadataHolders) {
