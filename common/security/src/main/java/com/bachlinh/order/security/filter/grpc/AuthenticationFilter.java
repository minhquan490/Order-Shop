...
public class AuthenticationFilter extends GrpcWebFilter {
    ...
    public AuthenticationFilter(DependenciesContainerResolver containerResolver, Collection<String> excludePaths, PathMatcher pathMatcher, String profile) {
        super(containerResolver.getDependenciesResolver(), profile);
    ...
    @Override
    protected <U> void intercept(HttpServletRequest request, HttpServletResponse response, ServerCall<InboundMessage, U> call) throws IOException {
