...
import com.bachlinh.order.repository.cache.CacheAllocator;
import com.bachlinh.order.repository.cache.CacheDestroyer;
import com.bachlinh.order.repository.cache.CacheLoader;
...
public class EhHeapCacheManager extends AbstractCacheManager<CacheManager> {
    ...
    private static class Context implements CacheAllocator, CacheLoader, CacheDestroyer {
        ...
        @Override
        public Cache allocate(com.bachlinh.order.repository.cache.CacheManager<?> cacheManager, String alias) {
