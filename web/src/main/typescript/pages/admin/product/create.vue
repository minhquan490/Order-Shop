...
export default {
  ...
  setup() {
    ...
    const formSchema = object({
      ...
      size: string().min(2, 'Size must be greater than 2 char').max(10, 'Size must be less than 10 char').required("Size is required"),
  ...
  methods: {
    submit(value: Record<string, string>) {
      ...
      const checkedElements = elements.filter(ele => ele.checked);
      if (checkedElements.length === 0 && this.pageData) {
        this.pageData.categoryError = 'Product require categories';
        return;
      }
      ...
      console.log(value);
      console.log(elements.filter(ele => ele.checked));
      return;
    }
  }
}
...
<template>
  <div class="product-create">
    <div class="pt-24 px-8 grid grid-cols-4">
      ...
      <Form @submit="(value) => submit(value)" :validation-schema="formSchema" class="col-start-2 col-span-2 p-8 grid grid-cols-2 gap-6 rounded-lg form">
        ...
        <div class="col-span-1">
          <div class="relative">
            ...
            <Field name="price" type="number" class="outline-none px-3 border border-gray-400 rounded-lg leading-7 w-full" />
        ...
        <div class="col-span-1">
          <div class="relative">
            ...
            <Field name="color" type="text" class="outline-none px-3 border border-gray-400 rounded-lg leading-7 w-full" />
        ...
        <div class="col-span-1">
          <div class="relative">
            ...
            <Field name="taobao_url" type="text" class="outline-none px-3 border border-gray-400 rounded-lg leading-7 w-full" />
            <ErrorMessage name="taobao_url" class="text-red-600 absolute -bottom-[1.3rem] right-0 w-max text-sm visible" />  
          </div>
        </div>
        <div class="col-span-1">
          <div class="relative">
            <span class="hover:cursor-default pb-1 pl-1">Order point</span>
            <Field name="orderPoint" type="number" class="outline-none px-3 border border-gray-400 rounded-lg leading-7 w-full" />
          ...
          <div class="col-span-1">
            ...
            <details class="relative">
              <summary class="text-sm border px-1 py-[0.25rem] rounded-md border-gray-400 bg-white hover:cursor-pointer">
                --- Choose ---</summary>
              <ul class="absolute bg-white w-full mt-1 rounded-md shadow-[0_5px_15px_5px_rgba(0,0,0,0.35)]">
        ...
        <div class="col-span-2">
          ...
          <textarea :ref="'product-description'"
            class="w-full outline-none border border-gray-400" rows="3"></textarea>
        </div>
        <div class="col-span-2">
          <ButtonSubmit :name="'Create product'" :textSize="'0.875rem'" :color="'white'"
