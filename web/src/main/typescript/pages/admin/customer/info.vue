            ...
            <div class="col-start-2 col-end-6 bg-white p-6 rounded-md edit-area grid grid-cols-2 gap-x-10">
              ...
              <div class="relative z-0 w-full mb-6 mt-4 group col-span-1">
                <input type="number"
                       ...
                       class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                       placeholder=" "
                       v-model="customerInfo.order_point"/>
                <label for="orderPoint"
                       class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                  Order point
                </label>
              </div>
              <div class="relative z-0 w-full mb-6 mt-4 group col-span-1 flex items-end w-full">
                <div class="flex items-center absolute left-[2rem]">
                  ...
                  <input type="checkbox"
                         ...
                         :checked="customerInfo.is_enabled"
                         @change="event => customerInfo.is_enabled = event.target.checked"/>
                </div>
                <div class="flex items-center absolute right-[2rem]">
                  ...
                  <input type="checkbox"
                         ...
                         id="activated"
                         class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2"
                         :checked="customerInfo.is_activated"
                         @change="event => customerInfo.is_activated = event.target.checked">
                </div>
              </div>
              <div class="relative z-0 w-full mb-6 mt-4 group col-span-2 grid grid-cols-3">
                <div class="col-span-1 flex items-center">
                  ...
                  <input type="checkbox"
                         ...
                         class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2"
                         :checked="customerInfo.is_account_non_expired"
                         @change="event => customerInfo.is_account_non_expired = event.target.checked">
                </div>
                <div class="col-span-1 flex items-center">
                  ...
                  <input type="checkbox"
                         ...
                         id="accountNonLocked"
                         class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2"
                         :checked="customerInfo.is_account_non_locked"
                         @change="event => customerInfo.is_account_non_locked = event.target.checked">
                </div>
                <div class="col-span-1 flex items-center">
                  ...
                  <input type="checkbox"
                         ...
                         class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2"
                         :checked="customerInfo.is_credentials_non_expired"
                         @change="event => customerInfo.is_credentials_non_expired = event.target.checked">
                </div>
              </div>
              <div class="relative z-0 w-max mt-4 group col-span-2 flex items-center hover:cursor-pointer"
                   @click="rotateIcon">
                <p>Address</p>
                <Icon class="ease-in duration-200 origin-center"
                      :class="{'rotate-90': rotateAddressIcon}"
              ...
              <div
                  class="relative z-0 w-full mb-6 group col-span-2 ease-in-out duration-[700ms] overflow-hidden"
                ...
                <ul v-if="selectedAddresses.length !== 0"
                    class="w-full space-y-1 text-gray-700 list-disc list-inside pt-2">
                  <li v-for="selected in selectedAddresses"
                      class="w-full flex justify-between"
                      :key="selected">
                    <span class="hover:cursor-default">
                      {{
                        selected.house_number + ', ' + selected.ward.name + ', ' + selected.district.name + ', ' + selected.province.name
                      }}
                    </span>
                    <Icon @click="removeSelectedAddress(selected)"
                        ...
                        <div class="relative z-0 w-full mb-6 mt-4 group col-span-2 grid grid-cols-3">
                          <div class="col-span-1">
                            ...
                            <select name="province"
                                    ...
                                    @change="event => fetchDistrict(JSON.parse(event.target.value))"
                                    ref="province">
                              <option value="" selected disabled>-- Choose province --</option>
                              <option v-for="province in provinceSource"
                                      :key="province"
                          ...
                          <div class="col-span-1">
                            ...
                            <select name="district"
                                    id="district"
                                    class="block w-[90%] p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                                    @change="event => fetchWard(JSON.parse(event.target.value))"
                                    ref="district">
                              <option value="" selected disabled>-- Choose district --</option>
                              <option v-for="district in districtSource"
                                      :key="district"
                          ...
                          <div class="col-span-1">
                            ...
                            <select name="ward"
                              ...
                              <option v-for="ward in wardSource"
                                      :key="ward"
              ...
              <div class="fixed top-[4.5rem] right-0 w-[22%]">
                <alert-list-error :error-messages="alertErrorContents"
                                  :hidden="alertErrorContents.length === 0"
                                  :title="'Update customer failure'"
